...
\begin{figure}[!htb]
\includegraphics{../figs/survey_nodig.pdf}
\caption{Survey experiments: Average treatment effect of corruption information on incumbent vote share and 95\% confidence intervals, excluding studies using digital measurement}
\label{fig: survey_nodig}
\end{figure}
