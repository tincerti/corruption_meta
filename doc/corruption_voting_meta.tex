...
\begin{abstract}
\noindent
Do voters hold politicians accountable for corruption? Field experiments often provide voters with information about corrupt acts of politicians then monitor vote choice. Vote choice survey experiments commonly inform respondents of corrupt acts of hypothetical candidates. Meta-analysis demonstrates that corrupt candidates are punished by zero percentage points in field experiments and 32 in survey experiments. The point estimates provided by survey experiments are therefore likely not representative of real-world voting behavior. This discrepancy does not appear to be driven by publication bias. Small effects in field experiments may stem from weak treatments and noncompliance. Large effects in survey experiments may stem from social desirability bias and the lower and hypothetical nature of costs. Conjoint experiments introduce hypothetical costly tradeoffs, but it may be best to examine the probability of voting for candidates with realistic sets of theoretically motivated characteristics when researchers have priors about conditions that shape voter decision making. 
\end{abstract}
