...
\begin{abstract}
\noindent
Do voters hold politicians accountable for corruption? Field experiments often provide voters with information about corrupt acts of politicians, then monitor vote choice. Similarly, vote-choice survey experiments commonly inform respondents of corrupt acts of hypothetical candidates. Meta-analysis demonstrates that corrupt candidates are punished by zero percentage points in field experiments, but approximately 32 in survey experiments. The point estimates survey experiments provide may therefore not be representative of real-world voting behavior. This discrepancy does not appear to be driven by publication bias. Small effects in field experiments may stem from weak treatments and noncompliance, and large effects in survey experiments from social desirability bias and the lower and hypothetical nature of costs. Conjoint experiments introduce hypothetical costly tradeoffs, but it may be best to examine the probability of voting for candidates with realistic sets of theoretically motivated characteristics when researchers have priors about conditions that shape voter decision making.
\end{abstract}
...
By contrast, meta-analysis suggests that: (1) In aggregate, the effect of providing information about incumbent corruption on incumbent vote share in field experiments is approximately zero, and (2) corrupt candidates are punished by respondents by approximately 32 percentage points across survey experiments. This suggests that the point estimates provided by vote choice survey experiments may not be representative of real-world voting behavior.
