...
################################################################################
# Run meta-analysis of lab experiments only
################################################################################
...
lab$author_reduced = fct_relevel(lab$author_reduced, "Fixed effects model", after = 0)
lab$author_reduced = fct_relevel(lab$author_reduced, "Random effects model", after = 0)
